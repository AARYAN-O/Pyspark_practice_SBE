# How does explode works on dictionaries?
# explode separates key values pairs in the dictionaries into two separate columns.
...
df=df.select("name",explode(df.properties))
